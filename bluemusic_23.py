...
def do_blue_23(filename):
	...
	to_wav('blue_23_inst/drums_clicks.wav', inst_slaps, revpol)
	...
	to_wav('blue_23_inst/drums_revcrash.wav', inst_revcrash, revpol)
	...
	to_wav('blue_23_inst/drums_hicrash.wav', inst_hicrash, revpol)
	...
	to_wav('blue_23_inst/drums_crash.wav', inst_crash, revpol)
	...
	to_wav('blue_23_inst/drums_predrum.wav', inst_predrum, revpol)
	...
	wip -= inst_revcrash
	inst_locrash = wip
	to_wav('blue_23_inst/drums_locrash.wav', inst_locrash, revpol)
